...
const variationMap = [
  {
    ...
    getColors: (color: Color) => generateVariations(color.toRgb(), 15).map((rgb) => generateColor(rgb).toHexString())
  },
  {
    label: 'Tints',
    ...
    getColors: (color: Color) => generateVariations(color.toRgb(), 15, { r: 255, g: 255, b: 255 }).map((rgb) => generateColor(rgb).toHexString())
  },
  {
    label: 'Tones',
    ...
    getColors: (color: Color) => generateVariations(color.toRgb(), 15, { r: 127.5, g: 127.5, b: 127.5 }).map((rgb) => generateColor(rgb).toHexString())
  },
  {
    label: 'Hues',
