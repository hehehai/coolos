...
const harmoniesMap = [
  {
    ...
    getColors: (color: Color) =>
      colorAnalogous(color.toHsv()).map((rgb) =>
  ...
  },
  {
    ...
    getColors: (color: Color) =>
      colorComplementary(color.toHsv()).map((rgb) =>
        generateColor(rgb).toHexString()
      ),
  },
  {
    ...
    getColors: (color: Color) =>
      colorSplitComplementary(color.toHsv()).map((rgb) =>
        generateColor(rgb).toHexString()
      ),
  },
  {
    ...
    getColors: (color: Color) =>
      colorTriadic(color.toHsv()).map((rgb) =>
        generateColor(rgb).toHexString()
      ),
  },
  {
    ...
    getColors: (color: Color) =>
      colorTetradic(color.toHsv()).map((rgb) =>
        generateColor(rgb).toHexString()
      ),
  },
  {
    ...
    getColors: (color: Color) =>
      colorSquare(color.toHsv()).map((rgb) => generateColor(rgb).toHexString()),
  },
]
