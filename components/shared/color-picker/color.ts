...
export class Color extends TinyColor {
  ...
  public static xyzaToRgb(sourceXyza: XYZ): Numberify<RGB> {
    ...
    return clampRgba({
      r: unlinearizeRgbChannel(
        0.032404542 * xyz.x - 0.015371385 * xyz.y - 0.004985314 * xyz.z
      ),
      g: unlinearizeRgbChannel(
        -0.00969266 * xyz.x + 0.018760108 * xyz.y + 0.00041556 * xyz.z
      ),
      b: unlinearizeRgbChannel(
        0.000556434 * xyz.x - 0.002040259 * xyz.y + 0.010572252 * xyz.z
      ),
    })
  }
  ...
  public static labToRgb(laba: LAB): Numberify<RGB> {
    ...
    return Color.xyzaToRgb({
      ...
      y:
        (laba.l > k * e ? Math.pow((laba.l + 16) / 116, 3) : laba.l / k) *
        D50.y,
